...
ops_edit $ceilomter_com oslo_messaging_rabbit rabbit_host $CON_MGNT_IP
...
ops_edit $ceilomter_com keystone_authtoken auth_uri http://$CON_MGNT_IP:5000
ops_edit $ceilomter_com keystone_authtoken auth_url http://$CON_MGNT_IP:35357
ops_edit $ceilomter_com keystone_authtoken auth_plugin password
ops_edit $ceilomter_com keystone_authtoken project_domain_id default
ops_edit $ceilomter_com keystone_authtoken user_domain_id default
